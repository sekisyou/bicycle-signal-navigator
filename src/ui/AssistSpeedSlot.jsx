    ...
    return {
      ...
      slots: [
        ...
        },
        {
          ...
          kind: leftBlue ? "blue" : "gray",
          band: leftBlue,
          text: leftBlue ? fmt1(bandMax(leftBlue)) : "",
          current: false,
          subtleDividerRight: false,
          showText: !!leftBlue,
        },
        ...
        },
        {
          ...
          kind: rightBlue ? "blue" : "gray",
          band: rightBlue,
          text: rightBlue ? fmt1(bandMin(rightBlue)) : "",
          current: false,
          subtleDividerRight: false,
          showText: !!rightBlue,
        },
      ...
      >
        ...
        >
          <div style={{ display: "grid", gap: 2 }}>
            ...
            <div style={{ fontSize: 16, fontWeight: 800 }}>{targetLabel}</div>
        ...
        >
          <div style={{ fontSize: 18, fontWeight: 900, color: "#555" }}>
            データ不足
          </div>
          <div style={{ marginTop: 5, fontSize: 12, color: "#777" }}>
